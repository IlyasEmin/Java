...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
        ...
        //lastindexof () iki parametre ile kullanilirsa ikinci parametrede verilen sayiyi indek olarak kabul edip
        //en bastan bu indexe kadar olan karakterleri bir kutu icine alip, lastindexof u sadece bu kutu icinde kullanir.
